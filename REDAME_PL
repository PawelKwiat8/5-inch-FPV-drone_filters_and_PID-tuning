...
Przepraszam za zamieszanie, masz absolutną rację. Źle zinterpretowałem kolejność. Poprawmy to, aby tabela dokładnie odzwierciedlała Twój proces pracy: każda zmiana generuje kolejny log.

Oto wersja, która powinna być już w 100% poprawna.

---

### Proces Optymalizacji i Analiza Opóźnień


| Krok | Wprowadzona Zmiana | Log Wynikowy | Roll (Gyro / Dterm ms) | Pitch (Gyro / Dterm ms) | Yaw (Gyro / Dterm ms) |
| :--: | :--- | :---: | :---: | :---: | :---: |
| 0 | **Wartości domyślne** | **Log 1** | 1.875 / 1.75 | 1.875 / 1.875 | 2.25 / - |
| 1 | `rpm_filter_weights = 100, 60, 75` | **Log 2** | Brak danych | Brak danych | Brak danych |
| 2 | `rpm_filter_q = 1000`, `q_factor = 300`, `notch_count = 3` | **Log 3** | 1.875 / 1.875 | 1.875 / 1.875 | 2.0 / - |
| 3 | `gyro_filter_multiplier = 2` | **Log 4** | 1.625 / 1.875 | 1.75 / 1.875 | 2 / - |
...
#### Podsumowanie
*  **Proces optymalizacji został zatrzymany na kroku 8.** , analiza  log009 wykazała, że szum na osi `dterm`  przekraczał docelowy poziom -10dB.
